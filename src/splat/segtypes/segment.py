...
class Segment:
    ...
    def __init__(
        ...
        self.can_see_segments: List[str] = []
    ...
    def from_yaml(
        ...
        if isinstance(yaml, dict):
            ...
            ret.can_see_segments = yaml.get("can_see_segments", [])
            assert isinstance(ret.can_see_segments, list), f"{ret.name}, {ret.can_see_segments}"
